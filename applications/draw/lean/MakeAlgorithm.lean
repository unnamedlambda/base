...
--
-- Actions:
--   [0] Worker: dst=0, src=1 → calls fn u0:1 with shared memory base ptr
--   [1] AsyncDispatch: posts action[0] to cranelift unit 0
--   [2] Wait: spins until completion flag is set
-- ---------------------------------------------------------------------------
