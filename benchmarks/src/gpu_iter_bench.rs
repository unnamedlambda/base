...
fn build_base_iterative_verify(data: &[f32], passes: usize, output_path: &str) -> base::Algorithm {
    ...
    base::Algorithm {
        ...
        units: UnitSpec {
            simd_units: 0, gpu_units: 1, file_units: 1,
            memory_units: 0, ffi_units: 0, hash_table_units: 0,
            cranelift_units: 0, backends_bits: 0xFFFF_FFFF,
        },
        simd_assignments: vec![], memory_assignments: vec![],
        file_assignments: vec![], ffi_assignments: vec![],
        hash_table_assignments: vec![],
...
fn build_clif_gpu_iter_algorithm(data: &[f32], passes: usize, output_path: &str) -> base::Algorithm {
    ...
    base::Algorithm {
        ...
        units: UnitSpec {
            simd_units: 0, gpu_units: 0, file_units: 0,
            memory_units: 0, ffi_units: 0, hash_table_units: 0,
