...
fn build_base_vec_add(a: &[f32], b: &[f32]) -> base::Algorithm {
    ...
    base::Algorithm {
        ...
        payloads,
        state: State {
            regs_per_unit: 0, gpu_size: 0, computational_regs: 0,
            file_buffer_size: 0, gpu_shader_offsets: vec![],
            cranelift_ir_offsets: vec![CLIF_OFF],
        },
        units: UnitSpec {
            simd_units: 0, gpu_units: 0, computational_units: 0,
            file_units: 0, network_units: 0, memory_units: 0,
            ffi_units: 0, hash_table_units: 0, lmdb_units: 0,
            cranelift_units: 1, backends_bits: 0,
        },
        simd_assignments: vec![], computational_assignments: vec![],
        memory_assignments: vec![], file_assignments: vec![],
        network_assignments: vec![], ffi_assignments: vec![],
