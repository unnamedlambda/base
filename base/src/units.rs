...
unsafe extern "C" fn cl_cuda_stream_create(ctx_ptr: *mut CraneliftCudaContext) -> i32 {
    std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        let Some(ctx) = read_ctx_mut::<CraneliftCudaContext>(ctx_ptr) else {
            return -1;
        };
...
unsafe extern "C" fn cl_cuda_stream_sync(
    ctx_ptr: *mut CraneliftCudaContext,
    stream_id: i32,
) -> i32 {
    std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
...
unsafe extern "C" fn cl_cuda_stream_destroy(
    ctx_ptr: *mut CraneliftCudaContext,
    stream_id: i32,
) -> i32 {
    if stream_id < 0 {
...
unsafe extern "C" fn cl_cuda_event_create(ctx_ptr: *mut CraneliftCudaContext) -> i32 {
    std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        let Some(ctx) = read_ctx_mut::<CraneliftCudaContext>(ctx_ptr) else {
            return -1;
        };
...
unsafe extern "C" fn cl_cuda_event_record(
    ctx_ptr: *mut CraneliftCudaContext,
    event_id: i32,
    stream_id: i32,
) -> i32 {
...
unsafe extern "C" fn cl_cuda_stream_wait_event(
    ctx_ptr: *mut CraneliftCudaContext,
    stream_id: i32,
    event_id: i32,
) -> i32 {
...
unsafe extern "C" fn cl_cuda_event_elapsed_ms_bits(
    ctx_ptr: *mut CraneliftCudaContext,
    start_event_id: i32,
    end_event_id: i32,
) -> i32 {
...
unsafe extern "C" fn cl_cuda_event_destroy(
    ctx_ptr: *mut CraneliftCudaContext,
    event_id: i32,
) -> i32 {
    if event_id < 0 {
...
unsafe extern "C" fn cl_cuda_graph_begin_capture(
    ctx_ptr: *mut CraneliftCudaContext,
    stream_id: i32,
) -> i32 {
    std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
...
unsafe extern "C" fn cl_cuda_graph_end_capture(
    ctx_ptr: *mut CraneliftCudaContext,
    stream_id: i32,
) -> i32 {
    std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
...
unsafe extern "C" fn cl_cuda_graph_upload(
    ctx_ptr: *mut CraneliftCudaContext,
    graph_id: i32,
    stream_id: i32,
) -> i32 {
...
unsafe extern "C" fn cl_cuda_graph_launch(
    ctx_ptr: *mut CraneliftCudaContext,
    graph_id: i32,
    stream_id: i32,
) -> i32 {
...
unsafe extern "C" fn cl_cuda_graph_destroy(
    ctx_ptr: *mut CraneliftCudaContext,
    graph_id: i32,
) -> i32 {
    if graph_id < 0 {
...
unsafe extern "C" fn cl_cuda_pinned_alloc(ctx_ptr: *mut CraneliftCudaContext, size: i64) -> i32 {
    if size <= 0 {
        return -1;
    }
    std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
...
unsafe extern "C" fn cl_cuda_pinned_ptr(ctx_ptr: *mut CraneliftCudaContext, pinned_id: i32) -> i64 {
    if pinned_id < 0 {
        return -1;
    }
    std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
...
unsafe extern "C" fn cl_cuda_pinned_free(
    ctx_ptr: *mut CraneliftCudaContext,
    pinned_id: i32,
) -> i32 {
    if pinned_id < 0 {
...
unsafe extern "C" fn cl_cuda_upload_ptr_async(
    ctx_ptr: *mut CraneliftCudaContext,
    buf_id: i32,
    src_ptr: *const u8,
    size: i64,
...
unsafe extern "C" fn cl_cuda_upload_ptr_offset_async(
    ctx_ptr: *mut CraneliftCudaContext,
    buf_id: i32,
    buf_offset: i64,
    src_ptr: *const u8,
...
unsafe extern "C" fn cl_cuda_download_ptr_async(
    ctx_ptr: *mut CraneliftCudaContext,
    buf_id: i32,
    dst_ptr: *mut u8,
    size: i64,
...
unsafe extern "C" fn cl_cuda_launch_on_stream(
    ctx_ptr: *mut CraneliftCudaContext,
    kernel_ptr: *const u8,
    n_bufs: i32,
    bind_ptr: *const u8,
...
unsafe extern "C" fn cl_cuda_launch_named_on_stream(
    ctx_ptr: *mut CraneliftCudaContext,
    kernel_ptr: *const u8,
    name_ptr: *const u8,
    n_bufs: i32,
...
unsafe extern "C" fn cl_cublas_sgemv_on_stream(
    ctx_ptr: *mut CraneliftCudaContext,
    trans: i32,
    m: i32,
    n: i32,
...
#[allow(clippy::too_many_arguments)]
unsafe extern "C" fn cl_cublas_sgemm_strided_batched_on_stream(
    ctx_ptr: *mut CraneliftCudaContext,
    transa: i32,
    transb: i32,
    m: i32,
...
> {
    ...
    builder.symbol(
        ...
        cl_cuda_upload_ptr_offset as *const u8,
    );
    builder.symbol(
        "cl_cuda_upload_ptr_async",
        cl_cuda_upload_ptr_async as *const u8,
    );
    builder.symbol(
        "cl_cuda_upload_ptr_offset_async",
        cl_cuda_upload_ptr_offset_async as *const u8,
    );
    ...
    builder.symbol("cl_cuda_stream_create", cl_cuda_stream_create as *const u8);
    builder.symbol("cl_cuda_stream_sync", cl_cuda_stream_sync as *const u8);
    builder.symbol(
        "cl_cuda_stream_destroy",
        cl_cuda_stream_destroy as *const u8,
    );
    builder.symbol("cl_cuda_event_create", cl_cuda_event_create as *const u8);
    builder.symbol("cl_cuda_event_record", cl_cuda_event_record as *const u8);
    builder.symbol(
        "cl_cuda_stream_wait_event",
        cl_cuda_stream_wait_event as *const u8,
    );
    builder.symbol(
        "cl_cuda_event_elapsed_ms_bits",
        cl_cuda_event_elapsed_ms_bits as *const u8,
    );
    builder.symbol("cl_cuda_event_destroy", cl_cuda_event_destroy as *const u8);
    builder.symbol(
        "cl_cuda_graph_begin_capture",
        cl_cuda_graph_begin_capture as *const u8,
    );
    builder.symbol(
        "cl_cuda_graph_end_capture",
        cl_cuda_graph_end_capture as *const u8,
    );
    builder.symbol("cl_cuda_graph_upload", cl_cuda_graph_upload as *const u8);
    builder.symbol("cl_cuda_graph_launch", cl_cuda_graph_launch as *const u8);
    builder.symbol("cl_cuda_graph_destroy", cl_cuda_graph_destroy as *const u8);
    builder.symbol("cl_cuda_pinned_alloc", cl_cuda_pinned_alloc as *const u8);
    builder.symbol("cl_cuda_pinned_ptr", cl_cuda_pinned_ptr as *const u8);
    builder.symbol("cl_cuda_pinned_free", cl_cuda_pinned_free as *const u8);
    ...
    builder.symbol(
        ...
        cl_cuda_launch_on_stream as *const u8,
    );
    builder.symbol(
        "cl_cuda_launch_named_on_stream",
        cl_cuda_launch_named_on_stream as *const u8,
    );
    ...
    builder.symbol(
        ...
        cl_cublas_sgemv_on_stream as *const u8,
    );
    builder.symbol(
    ...
    builder.symbol(
        ...
        cl_cublas_sgemm_strided_batched_on_stream as *const u8,
    );
