...
block0(v0: i64):
    ...
    v6 = iadd_imm v0, 5010
    v7 = iconst.i32 6
    v8 = call fn2(v91, v3, v4, v5, v6, v7)
    v9 = iadd_imm v0, 5100
    v10 = call fn3(v91, v3, v4, v5, v9)
    store.i32 v10, v0+5300
    v11 = call fn4(v91, v3, v4, v5)
    v12 = iadd_imm v0, 5200
    v13 = call fn3(v91, v3, v4, v5, v12)
...
block0(v0: i64):
    ...
    v6 = iadd_imm v0, 5000
    v7 = iadd_imm v0, 5030
    v8 = call fn2(v91, v3, v6, v5, v7, v5)
    v9 = iadd_imm v0, 5010
    v10 = iadd_imm v0, 5040
    v11 = call fn2(v91, v3, v9, v5, v10, v5)
    v12 = iadd_imm v0, 5020
    v13 = iadd_imm v0, 5050
    v14 = call fn2(v91, v3, v12, v5, v13, v5)
    v15 = call fn5(v91, v3)
    v16 = iadd_imm v0, 5100
    v17 = call fn3(v91, v3, v6, v5, v16)
    store.i32 v17, v0+5400
    v18 = iadd_imm v0, 5200
    v19 = call fn3(v91, v3, v9, v5, v18)
    store.i32 v19, v0+5404
    v20 = iadd_imm v0, 5300
    v21 = call fn3(v91, v3, v12, v5, v20)
...
block0(v0: i64):
    ...
    v5 = iadd_imm v0, 5000
    v6 = iadd_imm v0, 5030
    v7 = call fn2(v91, v3, v5, v4, v6, v4)
    v8 = iadd_imm v0, 5010
    v9 = call fn2(v91, v3, v8, v4, v6, v4)
    v10 = iadd_imm v0, 5020
    v11 = call fn2(v91, v3, v10, v4, v6, v4)
    v12 = iadd_imm v0, 5040
    v13 = iconst.i32 0
    v14 = iconst.i32 100
    v15 = iadd_imm v0, 5100
    v16 = call fn3(v91, v3, v12, v13, v14, v15)
...
block0(v0: i64):
    ...
    v9 = iadd_imm v0, 5001
    v10 = iadd_imm v0, 5200
    v11 = call fn3(v91, v3, v9, v5, v10)
...
block0(v0: i64):
    ...
    v8 = call fn2(v91, v3, v4, v5, v6, v7)
    v9 = iadd_imm v0, 5020
    v10 = call fn2(v91, v3, v4, v5, v9, v7)
    v11 = iadd_imm v0, 5100
    v12 = call fn3(v91, v3, v4, v5, v11)
...
block0(v0: i64):
    ...
    v3 = call fn1(v91, v1, v2)
    v4 = iconst.i32 1
    v20 = iadd_imm v0, 5060
    v5 = iadd_imm v0, 5000
    v6 = call fn2(v91, v3, v5, v4, v20, v4)
    v7 = iadd_imm v0, 5001
    v8 = call fn2(v91, v3, v7, v4, v20, v4)
    v9 = iadd_imm v0, 5002
    v10 = call fn2(v91, v3, v9, v4, v20, v4)
    v11 = iadd_imm v0, 5003
    v12 = call fn2(v91, v3, v11, v4, v20, v4)
    v13 = iadd_imm v0, 5004
    v14 = call fn2(v91, v3, v13, v4, v20, v4)
    v15 = iconst.i32 100
    v16 = iadd_imm v0, 5200
    v17 = call fn3(v91, v3, v9, v4, v15, v16)
...
block0(v0: i64):
    ...
    v5 = iconst.i32 1
    v6 = iadd_imm v0, 5010
    v7 = call fn2(v91, v3, v4, v5, v6, v5)
    v8 = call fn3(v91, v3)
    store.i32 v8, v0+5100
    v9 = iconst.i64 4256
    v10 = iconst.i64 5100
...
block0(v0: i64):
    ...
    v8 = iadd_imm v0, 5020
    v9 = iconst.i32 2
    v10 = call fn3(v91, v3, v7, v5, v8, v9)
    store.i32 v10, v0+5104
    ; get key "a"
    v11 = iadd_imm v0, 5200
    v12 = call fn4(v91, v3, v7, v5, v11)
...
block0(v0: i64):
    ...
    v8 = iconst.i32 2
    ; put on bad handle
    v9 = call fn2(v91, v4, v5, v6, v7, v8)
    store.i32 v9, v0+5100
    ; get on bad handle
    v10 = iadd_imm v0, 5200
    v11 = call fn3(v91, v4, v5, v6, v10)
    store.i32 v11, v0+5104
    ; delete on bad handle
    v12 = call fn4(v91, v4, v5, v6)
    store.i32 v12, v0+5108
    ; sync on bad handle
    v13 = call fn5(v91, v4)
    ...
    v14 = iconst.i32 100
    v15 = iadd_imm v0, 5300
    v16 = call fn6(v91, v4, v5, v6, v14, v15)
...
block0(v0: i64):
    ...
    v6 = iconst.i32 2
    v7 = iadd_imm v0, 5010
    v8 = call fn3(v91, v3, v5, v6, v7, v6)
    ; second begin — should abort the first txn (k1=v1 lost)
    v9 = call fn2(v91, v3)
    ; put k2=v2 in second txn
    v10 = iadd_imm v0, 5020
    v11 = iadd_imm v0, 5030
    v12 = call fn3(v91, v3, v10, v6, v11, v6)
    ; commit second txn
    v13 = call fn4(v91, v3)
    ; get k1 — should fail (-1)
    v14 = iadd_imm v0, 5100
    v15 = call fn5(v91, v3, v5, v6, v14)
    store.i32 v15, v0+5200
    ; get k2 — should succeed
    v16 = iadd_imm v0, 5300
    v17 = call fn5(v91, v3, v10, v6, v16)
...
block0(v0: i64):
    ...
    v9 = iconst.i32 2
    ; put "k"="d1" in db1
    v10 = call fn2(v91, v3, v6, v7, v8, v9)
    ; put "k"="d2" in db2
    v11 = iadd_imm v0, 5020
    v12 = call fn2(v91, v5, v6, v7, v11, v9)
    ; get from db1
    v13 = iadd_imm v0, 5100
    v14 = call fn3(v91, v3, v6, v7, v13)
    store.i32 v14, v0+5200
    ; get from db2
    v15 = iadd_imm v0, 5300
    v16 = call fn3(v91, v5, v6, v7, v15)
...
block0(v0: i64):
    ...
    v15 = iconst.i32 0
    v16 = iconst.i32 2
    v17 = iadd_imm v0, 5200
    v18 = iadd_imm v0, 5100
    v19 = call fn3(v91, v3, v18, v15, v16, v17)
...
block0(v0: i64):
    ...
    ; upload A from pointer {a_off}
    v5 = iadd_imm v0, {a_off}
    v20 = call fn2(v91, v2, v5, v1)

    ; upload B from pointer {b_off}
    v6 = iadd_imm v0, {b_off}
    v21 = call fn2(v91, v3, v6, v1)

    ; launch PTX kernel: ptx at {ptx_off}, 3 bufs, binds at {bind_off}
    ; grid(1,1,1) block(64,1,1)
    v7 = iadd_imm v0, {ptx_off}
    v8 = iconst.i32 3
    v9 = iadd_imm v0, {bind_off}
    v10 = iconst.i32 1
    v11 = iconst.i32 1
    v12 = iconst.i32 1
    v13 = iconst.i32 64
    v14 = iconst.i32 1
    v15 = iconst.i32 1
    v22 = call fn4(v91, v7, v8, v9, v10, v11, v12, v13, v14, v15)

    ; download result to pointer {result_off}
    v16 = iadd_imm v0, {result_off}
    v23 = call fn3(v91, v4, v16, v1)

    ; write result to verify file
    v17 = iconst.i64 {file_off}
    v18 = iconst.i64 {result_off}
    v19 = iconst.i64 0
    v30 = call fn6(v0, v17, v18, v19, v1)
...
block0(v0: i64):
    ...
    v7 = iconst.i32 1
    v8 = iconst.i32 64
    v21 = call fn4(v91, v4, v5, v6, v7, v7, v7, v8, v7, v7)

    ; download
    v9 = iadd_imm v0, {result_off}
    v22 = call fn3(v91, v2, v9, v1)

    ; write to file
    v10 = iconst.i64 2000
    v11 = iconst.i64 {result_off}
    v12 = iconst.i64 0
    v23 = call fn6(v0, v10, v11, v12, v1)
...
block0(v0: i64):
    ...
    v8 = iconst.i32 64
    v21 = call fn4(v91, v4, v5, v6, v7, v7, v7, v8, v7, v7)
    v22 = call fn4(v91, v4, v5, v6, v7, v7, v7, v8, v7, v7)
    v23 = call fn4(v91, v4, v5, v6, v7, v7, v7, v8, v7, v7)

    v9 = iadd_imm v0, {result_off}
    v24 = call fn3(v91, v2, v9, v1)

    v10 = iconst.i64 2000
    v11 = iconst.i64 {result_off}
    v12 = iconst.i64 0
    v25 = call fn6(v0, v10, v11, v12, v1)
...
block0(v0: i64):
    ...
    v8 = iconst.i32 64
    v21 = call fn4(v91, v4, v5, v6, v7, v7, v7, v8, v7, v7)
    v9 = iadd_imm v0, {result_a_off}
    v22 = call fn3(v91, v2, v9, v1)

    ; round 2: re-upload B, launch, download
    v10 = iadd_imm v0, {data_b_off}
    v23 = call fn2(v91, v2, v10, v1)
    v24 = call fn4(v91, v4, v5, v6, v7, v7, v7, v8, v7, v7)
    v11 = iadd_imm v0, {result_b_off}
    v25 = call fn3(v91, v2, v11, v1)

    ; write both results to file
    v12 = iconst.i64 2000
    v13 = iconst.i64 {result_a_off}
    v14 = iconst.i64 0
    v15 = iconst.i64 {two_data_bytes}
    v26 = call fn6(v0, v12, v13, v14, v15)
...
block0(v0: i64):
    ...
    v10 = iconst.i64 3800
    v11 = iconst.i32 1
    v12 = call fn4(v91, v8, v9, v10, v9, v11, v11, v11, v11, v11)
    v23 = sextend.i64 v12
    store.i64 v23, v0+4524
